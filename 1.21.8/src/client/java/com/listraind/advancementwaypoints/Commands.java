...
public class Commands {
                        ...
                        ClientCommandManager.literal("advancementwaypoints")
                                .executes(context -> {
                                    ...
                                    if (AdvancementWaypoints.LOGGER != null)
                                        AdvancementWaypoints.LOGGER.info("Opened MainMenuScreen via /advancementwaypoints");
                                    return 1;
                                })
    ...
    private static int navigateCommand(int x, int y, int z) {
        ...
        nav.setTargets(
                Navigator.Dimension.from(player.level().dimension()),
                List.of(new BlockPos(x, y, z))
        );

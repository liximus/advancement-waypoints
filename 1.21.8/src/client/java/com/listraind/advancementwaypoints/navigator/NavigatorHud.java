...
public class NavigatorHud {
    ...
    private static final ResourceLocation ARROW = ResourceLocation.fromNamespaceAndPath(AdvancementWaypoints.MOD_ID, "textures/arrow.png");
    private static final ResourceLocation PORTAL = ResourceLocation.fromNamespaceAndPath(AdvancementWaypoints.MOD_ID, "textures/portal.png");
    ...
    void register() {
        HudElementRegistry.attachElementAfter(VanillaHudElements.DEBUG,
                ResourceLocation.fromNamespaceAndPath(AdvancementWaypoints.MOD_ID, "nav_hud"), this::render);
    }

    private void render(GuiGraphics g, DeltaTracker dt) {
    ...
    private void renderArrow(GuiGraphics g, Minecraft mc, Player player, BlockPos target, int sw, int sh) {
        ...
        g.drawString(mc.font, text, cx - tw / 2, ty, 0xFFFFFFFF, true);
    }

    private void renderPortal(GuiGraphics g, int sw, int sh) {
